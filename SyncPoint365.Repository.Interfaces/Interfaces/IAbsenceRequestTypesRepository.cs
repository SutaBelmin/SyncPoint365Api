...
namespace SyncPoint365.Repository.Common.Interfaces
{
    public interface IAbsenceRequestTypesRepository : IBaseRepository<AbsenceRequestType>
    {
        ...
        Task<IPagedList<AbsenceRequestType>> GetAbsenceRequestTypesPagedListAsync(bool? isActive, string? query, int page, int pageSize, string? sortOrder = null, CancellationToken cancellationToken = default);
    }
}
