...
namespace SyncPoint365.Service.Common.Interfaces
{
    ...
    {
        Task<IEnumerable<AbsenceRequestDTO>> GetAbsenceRequestListAsync(int? userId, DateTime? dateFrom, DateTime? dateTo, CancellationToken cancellationToken = default);
