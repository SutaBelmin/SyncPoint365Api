...
namespace SyncPoint365.Service.Common.Interfaces
{
    public interface IAbsenceRequestsService : IBaseService<AbsenceRequestDTO, AbsenceRequestAddDTO, AbsenceRequestUpdateDTO>
    {
        ...
        Task<IPagedList<AbsenceRequestDTO>> GetAbsenceRequestsPagedListAsync(string? query, DateTime dateFrom, DateTime dateTo, int page, int pageSize, CancellationToken cancellationToken = default);
    }
}
